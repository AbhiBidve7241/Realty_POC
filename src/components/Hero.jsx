...
const Hero = () => {
  ...
  return (
    <section id="home" className="relative h-screen flex items-start justify-center overflow-hidden scroll-mt-24">
      {/* Background Image */}
      <div
      ...
      <div className="container relative z-10 mx-auto px-6 md:px-12 pt-20">
        <div className="max-w-3xl text-white">
          ...
          >
            <span className="inline-block py-3 px-3 rounded-full bg-primary/20 text-primary border border-primary/30 text-sm font-semibold mb-6">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <a
                ...
                className="bg-primary text-charcoal px-8 py-4 rounded-md font-bold text-lg hover:bg-yellow-400 transition-colors flex items-center justify-center gap-2 group"
              >
                View Projects
              ...
              <a
                ...
                className="bg-white/10 backdrop-blur-md border border-white/30 text-white px-8 py-4 rounded-md font-bold text-lg hover:bg-white/20 transition-colors flex items-center justify-center"
              >
                Contact Us
              </a>
            </div>
